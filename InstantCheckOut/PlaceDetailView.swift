...
struct PlaceDetailView : View {
    ...
    @Binding var placeItem: InventoryPlaces?
    let defaultPoint = InventoryFamousPoints(id: 0, pointName: "Default", pointImage: "Default PlaceHolder", pointDescription: "Default Description PlaceHolder")
        ...
        GeometryReader { g in
            ZStack {
                ...
                VStack(alignment: .leading) {
                    Text(self.placeItem?.inventoryPlace ?? "")
...
struct PlacesCircleView: View {
    var placeItems: InventoryFamousPoints
    @ObservedObject var selectedPoint: SelectedPoint
